/*
 * HTTP Range Cache FS (HRCFS) version 0.7.1
 *
...
sudo -u www-data ./hrcfs /var/cache/hrcfs/media \
        ...
        -o complete_link_dir=/var/cache/hrcfs/links
 */
...
struct hrcfs_config conf = {
        1048576,                                        // set block_size in bytes
